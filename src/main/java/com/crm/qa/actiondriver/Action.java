...
import com.crm.qa.actioninterface.ActionInterface;
...
//    public void click3(WebDriver driver, WebElement ele) {
...
//    }
    ...
    public  void mouseOverElement(WebDriver driver,WebElement element) {
        ...
        try {
            ...
            if (flag) {
                ...
                System.out.println("MouseOver action is not performed on "+ element.getText());
            }
        }
    }
    ...
    public  boolean moveToElementThenClick(WebDriver driver, WebElement ele) {
        boolean flag = false;
        try {
            // WebElement element = driver.findElement(locator);
            JavascriptExecutor executor = (JavascriptExecutor) driver;
    ...
    public  void explicitWait(WebDriver driver, WebElement element, int timeOut ) {
        try {
            ...
            throw new RuntimeException(String.format("The following element was not visible: %s",e));
        }
    }
